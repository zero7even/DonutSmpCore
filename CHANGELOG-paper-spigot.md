...
## 1.2 Feature Toggle Build - Paper/Spigot - 2026-05-14
...
### Build
- Paper/Spigot build completed with `mvn -q -DskipTests package`.
- Built artifact: `target/ultimatedonutsmp-1.2.jar`.
