...
public class LunarRichPresenceManager {
    ...
    public void reload() {
        ...
        updateAll();
        updateTask = plugin.getFoliaScheduler().runGlobalTimer(this::updateAll, periodTicks, periodTicks);
    ...
    public void handleJoin(Player player) {
        ...
        plugin.getFoliaScheduler().runEntityLater(player, () -> updatePlayer(player), 100L);
    }
